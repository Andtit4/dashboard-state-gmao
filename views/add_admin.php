            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="#">Administateur</a></li>
                ...
                <form method="post" action="">
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" id="exampleInputEmail1" name="email" placeholder="Entrer votre email">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Nom</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="nom" placeholder="Entrer votre nom">
                      </div>
                    <div class="form-group">
                  ...
                  <div class="col-12">
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <tr>
                          <td><?= $list['id_admin']; ?></td>
                          <td><?= $list['nom_admin']; ?></td>
                          <td><?= $list['email']; ?></td>
                          <td><?= $list['pass_admin']; ?></td>
                        </tr>
                        <?php } ?>
                          </tbody>
                        </table>
