...
<body>
  <div class="container">
    ...
    <div id="items-row">
      ...
      <div id="chartContainer" style="margin-left: 2vw; height: 30vh; position: absolute; right: 66vw; width: 35%;"></div>



      <div id="chartContainerZoneLome" style="width: 20vw; height: 20vh;  position: fixed; left: 30vw">
      </div>
...
<script defer>
  document.addEventListener('DOMContentLoaded', (event) => {
    ...
    console.log(document.querySelector('#chartContainerZoneLome'))
    var chart2 = new CanvasJS.Chart("chartContainerZoneLome", {
      animationEnabled: true,
      exportEnabled: true,
      title: {
        text: "Rapport journalier global"
