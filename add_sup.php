...
$req1 = $bdd -> query("SELECT * FROM superviseur");
if (isset($_GET['id_admin'])){
    ...
    if (isset($_POST['ajouter'])){
        if (!empty($_POST['email'] && $_POST['nom'] && $_POST['pass'] && $_POST['passconf'])){
            ...
            if ($pass == $passconf){
                $req = $bdd -> query("INSERT INTO superviseur VALUES ('', '$nom', '$email', '$pass')");
                header("Location: add_sup.php?id_admin=".$id_admin);
            }
            else{
